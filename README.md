...
If step **1d)** returns error "WslRegisterDistribution failed with error: 0x80370114" after turning the two features on from **1c)**, try also turning the freature "Windows Hypervisor Platfrom" on and repeat step **1d)**
